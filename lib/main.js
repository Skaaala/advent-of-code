...
var $d71557870cfb59bc$exports = {};

$parcel$export($d71557870cfb59bc$exports, "Day03", () => $d71557870cfb59bc$export$67d6842a727a01b3);
const $1b698c245229da44$export$b7e3ae3d7c15e42e = `
...
var $60578c0a857cfa63$exports = {};

$parcel$export($60578c0a857cfa63$exports, "ASCII", () => $60578c0a857cfa63$export$4a7108e5554afff8);
let $60578c0a857cfa63$export$4a7108e5554afff8;
(function(ASCII) {
    ASCII[ASCII["a"] = 97] = "a";
    ASCII[ASCII["z"] = 122] = "z";
    ASCII[ASCII["A"] = 65] = "A";
    ASCII[ASCII["Z"] = 90] = "Z";
})($60578c0a857cfa63$export$4a7108e5554afff8 || ($60578c0a857cfa63$export$4a7108e5554afff8 = {}));


class $d71557870cfb59bc$export$67d6842a727a01b3 {
    ...
    getPriorities() {
        return [
            ...this.rangeArray((0, $60578c0a857cfa63$export$4a7108e5554afff8).a, (0, $60578c0a857cfa63$export$4a7108e5554afff8).z),
            ...this.rangeArray((0, $60578c0a857cfa63$export$4a7108e5554afff8).A, (0, $60578c0a857cfa63$export$4a7108e5554afff8).Z)
    ...
    getInputPart1() {
        let halfLength;
        return (0, $1b698c245229da44$export$b7e3ae3d7c15e42e).trim().split("\n").map((row)=>{
    ...
    getInputPart2() {
        const inputAsArr = (0, $1b698c245229da44$export$b7e3ae3d7c15e42e).trim().split("\n");
        const parsedArr = [];
...
var $4c7cef8c0136e378$exports = {};
var $3df63991c97b4916$exports = {};

$parcel$export($3df63991c97b4916$exports, "Day01", () => $3df63991c97b4916$export$37294ee5f5188979);
const $29b370194ed5ee1c$export$b7e3ae3d7c15e42e = `
5557
6663
3952
4750
...
class $3df63991c97b4916$export$37294ee5f5188979 {
    partOne() {
    ...
    getInput() {
        return (0, $29b370194ed5ee1c$export$b7e3ae3d7c15e42e).split("\n\n").map((row)=>row.replace(/\n/gmi, " ").trim().split(" ").map((v)=>+v));
    }
}


var $60fda99d3754d111$exports = {};

$parcel$export($60fda99d3754d111$exports, "Day02", () => $60fda99d3754d111$export$e42c37115f58c4a5);
const $445b8e240f498e61$export$b7e3ae3d7c15e42e = `
A Y
B Z
C Y
B Y
...
var $fa8e9ea991fce2ca$exports = {};

$parcel$export($fa8e9ea991fce2ca$exports, "OpponentTurn", () => $fa8e9ea991fce2ca$export$d6f79fe10a60fd16);
$parcel$export($fa8e9ea991fce2ca$exports, "MyTurn", () => $fa8e9ea991fce2ca$export$5aaf26e7c3f7a057);
$parcel$export($fa8e9ea991fce2ca$exports, "HowTurnShouldEnd", () => $fa8e9ea991fce2ca$export$3326728429fd56b2);
$parcel$export($fa8e9ea991fce2ca$exports, "RoundPoints", () => $fa8e9ea991fce2ca$export$86abd7436e8ab238);
let $fa8e9ea991fce2ca$export$d6f79fe10a60fd16;
(function(OpponentTurn) {
    OpponentTurn["ROCK"] = "A";
    OpponentTurn["PAPER"] = "B";
    OpponentTurn["SCISSORS"] = "C";
})($fa8e9ea991fce2ca$export$d6f79fe10a60fd16 || ($fa8e9ea991fce2ca$export$d6f79fe10a60fd16 = {}));
let $fa8e9ea991fce2ca$export$5aaf26e7c3f7a057;
(function(MyTurn) {
    MyTurn["ROCK"] = "X";
    MyTurn["PAPER"] = "Y";
    MyTurn["SCISSORS"] = "Z";
})($fa8e9ea991fce2ca$export$5aaf26e7c3f7a057 || ($fa8e9ea991fce2ca$export$5aaf26e7c3f7a057 = {}));
let $fa8e9ea991fce2ca$export$3326728429fd56b2;
(function(HowTurnShouldEnd) {
    HowTurnShouldEnd["LOST"] = "X";
    HowTurnShouldEnd["DRAW"] = "Y";
    HowTurnShouldEnd["WIN"] = "Z";
})($fa8e9ea991fce2ca$export$3326728429fd56b2 || ($fa8e9ea991fce2ca$export$3326728429fd56b2 = {}));
let $fa8e9ea991fce2ca$export$86abd7436e8ab238;
...
})($fa8e9ea991fce2ca$export$86abd7436e8ab238 || ($fa8e9ea991fce2ca$export$86abd7436e8ab238 = {}));


const $60fda99d3754d111$var$TurnScore = {
    [(0, $fa8e9ea991fce2ca$export$5aaf26e7c3f7a057).ROCK]: 1,
    [(0, $fa8e9ea991fce2ca$export$5aaf26e7c3f7a057).PAPER]: 2,
    [(0, $fa8e9ea991fce2ca$export$5aaf26e7c3f7a057).SCISSORS]: 3
};
const $60fda99d3754d111$var$WINNING_COMBINATIONS = [
    `${(0, $fa8e9ea991fce2ca$export$d6f79fe10a60fd16).ROCK}${(0, $fa8e9ea991fce2ca$export$5aaf26e7c3f7a057).PAPER}`,
    `${(0, $fa8e9ea991fce2ca$export$d6f79fe10a60fd16).PAPER}${(0, $fa8e9ea991fce2ca$export$5aaf26e7c3f7a057).SCISSORS}`,
    `${(0, $fa8e9ea991fce2ca$export$d6f79fe10a60fd16).SCISSORS}${(0, $fa8e9ea991fce2ca$export$5aaf26e7c3f7a057).ROCK}`
];
const $60fda99d3754d111$var$DRAW_COMBINATIONS = [
    `${(0, $fa8e9ea991fce2ca$export$d6f79fe10a60fd16).ROCK}${(0, $fa8e9ea991fce2ca$export$5aaf26e7c3f7a057).ROCK}`,
    `${(0, $fa8e9ea991fce2ca$export$d6f79fe10a60fd16).PAPER}${(0, $fa8e9ea991fce2ca$export$5aaf26e7c3f7a057).PAPER}`,
    `${(0, $fa8e9ea991fce2ca$export$d6f79fe10a60fd16).SCISSORS}${(0, $fa8e9ea991fce2ca$export$5aaf26e7c3f7a057).SCISSORS}`
];
const $60fda99d3754d111$var$LOST_COMBINATIONS = [
    `${(0, $fa8e9ea991fce2ca$export$d6f79fe10a60fd16).PAPER}${(0, $fa8e9ea991fce2ca$export$5aaf26e7c3f7a057).ROCK}`,
    `${(0, $fa8e9ea991fce2ca$export$d6f79fe10a60fd16).SCISSORS}${(0, $fa8e9ea991fce2ca$export$5aaf26e7c3f7a057).PAPER}`,
    `${(0, $fa8e9ea991fce2ca$export$d6f79fe10a60fd16).ROCK}${(0, $fa8e9ea991fce2ca$export$5aaf26e7c3f7a057).SCISSORS}`
];
class $60fda99d3754d111$export$e42c37115f58c4a5 {
    partOne() {
        const data = this.getInput();
    ...
    gameRoundResult(opponent, me) {
        ...
        if ($60fda99d3754d111$var$WINNING_COMBINATIONS.indexOf(round) > -1) result += (0, $fa8e9ea991fce2ca$export$86abd7436e8ab238).WIN;
        else if ($60fda99d3754d111$var$DRAW_COMBINATIONS.indexOf(round) > -1) result += (0, $fa8e9ea991fce2ca$export$86abd7436e8ab238).DRAW;
        return result + $60fda99d3754d111$var$TurnScore[me];
    }
    chooseCorrectCombination(opponent, shouldEnd) {
        let combinationsArray = $60fda99d3754d111$var$WINNING_COMBINATIONS;
        switch(shouldEnd){
            case (0, $fa8e9ea991fce2ca$export$3326728429fd56b2).WIN:
                combinationsArray = $60fda99d3754d111$var$WINNING_COMBINATIONS;
                break;
            case (0, $fa8e9ea991fce2ca$export$3326728429fd56b2).DRAW:
                combinationsArray = $60fda99d3754d111$var$DRAW_COMBINATIONS;
                break;
            case (0, $fa8e9ea991fce2ca$export$3326728429fd56b2).LOST:
                combinationsArray = $60fda99d3754d111$var$LOST_COMBINATIONS;
                break;
        }
    ...
    getInput() {
        return (0, $445b8e240f498e61$export$b7e3ae3d7c15e42e).split("\n").filter(Boolean).map((item)=>item.split(" "));
    }
}
...
$parcel$exportWildcard($4c7cef8c0136e378$exports, $3df63991c97b4916$exports);
$parcel$exportWildcard($4c7cef8c0136e378$exports, $60fda99d3754d111$exports);
$parcel$exportWildcard($4c7cef8c0136e378$exports, $fa8e9ea991fce2ca$exports);
$parcel$exportWildcard($4c7cef8c0136e378$exports, $d71557870cfb59bc$exports);
$parcel$exportWildcard($4c7cef8c0136e378$exports, $60578c0a857cfa63$exports);


const $882b6d93070905b3$var$resultOfDay = (day)=>{
    console.log("First part");
    console.log(day.partOne());
    console.log("\nSecond part");
    console.log(day.partTwo());
};
function $882b6d93070905b3$export$f22da7240b7add18() {
    //resultOfDay(new Day01());
    //resultOfDay(new Day02());
    $882b6d93070905b3$var$resultOfDay(new (0, $d71557870cfb59bc$export$67d6842a727a01b3)());
}
$882b6d93070905b3$export$f22da7240b7add18();
$parcel$exportWildcard(module.exports, $4c7cef8c0136e378$exports);
